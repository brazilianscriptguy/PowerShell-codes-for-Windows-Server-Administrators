...
objFSO.CopyFile "C:\ITSM-Templates\customimages\user*.*", ProgramPath, OverwriteExisting

'Copy the new operating system support images
objFSO.CopyFile "C:\ITSM-Templates\customimages\oemlogo.bmp", "C:\windows\system32\oemlogo.bmp", OverwriteExisting
