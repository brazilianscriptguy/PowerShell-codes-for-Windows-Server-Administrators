...
Dim regFiles
regFiles = Array( _
    "C:\ITSM-Templates-WKS\ModifyReg\AllGeneralConfigs\AddStartPageADM.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\AllGeneralConfigs\DisableUAC-LUA.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\AllGeneralConfigs\Enable-AutoShareAdmin.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\AllGeneralConfigs\Register-Owner.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\AllGeneralConfigs\Win10_Domain-Ingress.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\AllGeneralConfigs\WSUS-App-Intranet.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\DefaultBackground\DesktopCurrent.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\DefaultBackground\DesktopDefault.reg", _
    "C:\ITSM-Templates-WKS\ModifyReg\DefaultBackground\EnableCustomLogonBackgrounds.reg" _
)
...
Dim themePackPath
themePackPath = "C:\ITSM-Templates-WKS\ModifyReg\UserDesktopTheme\ITSM-Templates-WKS.deskthemepack"
