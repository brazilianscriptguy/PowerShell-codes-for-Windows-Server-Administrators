...
5. **(Optional) Add to PATH**: To access Log Parser from any directory, add the installation path (e.g., `C:\Program Files (x86)\Log Parser 2.2\`) to your system’s PATH environment variable.
